...
# settings
BACPYPES_DEVICE_NAME = _getenv("BACPYPES_DEVICE_NAME", "ORTS-BAS_480_ASP01°01_#####_###_AS~01_#####_DEV01")
BACPYPES_DEVICE_INSTANCE = _getenv("BACPYPES_DEVICE_INSTANCE", 48001)
