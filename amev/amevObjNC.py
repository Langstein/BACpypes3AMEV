...
class NC_GM_PSA_AMEV1(NotificationClassObject):
    ...
    description="Gebäudeautomationssystem Automationsschwerpunkt AS Meldeklasse Gefahr Person"
...
class NC_GM_OSA_AMEV1(NotificationClassObject):
    ...
    description="Gebäudeautomationssystem Automationsschwerpunkt AS Meldeklasse Gefahr Liegenschaft"
...
class NC_AM_GA_AMEV1(NotificationClassObject):
    ...
    description="Gebäudeautomationssystem Automationsschwerpunkt AS Meldeklasse Alarm"
...
class NC_VAM_GA_AMEV1(NotificationClassObject):
    ...
    description="Gebäudeautomationssystem Automationsschwerpunkt AS Meldeklasse Voralarm"
...
class NC_SM_GA_AMEV1(NotificationClassObject):
    ...
    description="Gebäudeautomationssystem Automationsschwerpunkt AS Meldeklasse Störung"
...
class NC_ANO_GA_AMEV1(NotificationClassObject):
    ...
    description="Gebäudeautomationssystem Automationsschwerpunkt AS Meldeklasse Anormal"
...
class NC_WM_GA_AMEV1(NotificationClassObject):
    ...
    description="Gebäudeautomationssystem Automationsschwerpunkt AS Meldeklasse Wartung"
...
class NC_WM_GAQ_AMEV1(NotificationClassObject):
    ...
    description="Gebäudeautomationssystem Automationsschwerpunkt AS Meldeklasse Wartung (quitierbar)"
...
class NC_RVM_GA_AMEV1(NotificationClassObject):
    ...
    description="Gebäudeautomationssystem Automationsschwerpunkt AS Meldeklasse Revision"
...
class NC_HD_GA_AMEV1(NotificationClassObject):
    ...
    description="Gebäudeautomationssystem Automationsschwerpunkt AS Meldeklasse Hand"
...
class NC_SYS_GA_AMEV1(NotificationClassObject):
    ...
    description="Gebäudeautomationssystem Automationsschwerpunkt AS Meldeklasse System"
...
class NC_TL_GA_AMEV1(NotificationClassObject):
    ...
    description="Gebäudeautomationssystem Automationsschwerpunkt AS Meldeklasse Trend"
...
class NC_SO_GA_AMEV1(NotificationClassObject):
    ...
    description="Gebäudeautomationssystem Automationsschwerpunkt AS Meldeklasse Sonstiges"
