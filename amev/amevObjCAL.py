...
class CAL_FT_AMEV1(CalendarObject):
            ...
            description="Gebäudeautomationssystem Automationsschwerpunkt AS Kalender Feiertage"
            presentValue=False
...
class CAL_SF_AMEV1(CalendarObject):
            ...
            description="Gebäudeautomationssystem Automationsschwerpunkt AS Kalender Schulferien"
            presentValue=False
            dateList=[] # ListOf(CalendarEntry)           
...
class CAL_BF_AMEV1(CalendarObject):
            ...
            description="Gebäudeautomationssystem Automationsschwerpunkt AS Kalender Betriebsferien"
            presentValue=False
            dateList=[] # ListOf(CalendarEntry)           
...
class CAL_ALG_AMEV1(CalendarObject):
            ...
            description="Gebäudeautomationssystem Automationsschwerpunkt AS Kalender allgemein"
            presentValue=False
            dateList="",#: ListOf(CalendarEntry            
